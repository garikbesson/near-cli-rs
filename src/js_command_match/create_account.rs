...
pub struct CreateAccountArgs {
    ...
    #[clap(long, aliases = ["use_faucet", "useFaucet"], default_value_t = false, conflicts_with = "master_account")]
    use_faucet: bool,
    ...
    #[clap(long, aliases = ["initial_balance", "initialBalance"], default_missing_value = Some("10"))]
